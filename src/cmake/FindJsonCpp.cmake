...
FIND_LIBRARY (JSONCPP_LIBRARY_RELEASE
               NAMES jsoncpp
               HINTS ${JSONCPP_ROOT_DIR}
               PATH_SUFFIXES lib ${_JSONCPP_POSSIBLE_LIB_SUFFIXES}
...
IF (JSONCPP_INCLUDE_DIR)
    ...
    IF (EXISTS ${_JSONCPP_VERSION_HEADER})
        FILE (STRINGS ${_JSONCPP_VERSION_HEADER} _JSONCPP_VERSION_TMP
              REGEX "^#define JSON_CPP_VERSION[ \t]+[0-9\\.]+")

        STRING (REGEX REPLACE "^#define JSON_CPP_VERSION[ \t]+([0-9\\.]+)(.*)" "\\1"
                _JSONCPP_VERSION_TMP ${_JSONCPP_VERSION_TMP})
        ...
        SET (JSONCPP_VERSION ${JSONCPP_VERSION_MAJOR}.${JSONCPP_VERSION_MINOR}.
